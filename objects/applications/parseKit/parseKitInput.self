...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'parseKit' -> 'inputExtent' -> 'parent' -> () From: ( | {
         ...
         - anInputPosition = ( |
            | 
            (start: start - anInputPosition) end: end - anInputPosition).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'parseKit' -> 'inputPosition' -> 'parent' -> () From: ( | {
         ...
         - ip = ( |
            | 
            "column and line are 1-origin"
            copyColumn: column - ip column pred Line: line - ip line pred Offset: offset - ip offset).
        } | ) 
