...
'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> () From: ( | {
         'ModuleInfo: Module: usLexer InitialContents: FollowSlot'
        
         usLexer = bootstrap define: bootstrap stub -> 'globals' -> 'modules' -> 'usLexer' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals modules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'modules' -> 'usLexer' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals modules usLexer.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'usLexer' -> () From: ( | {
         'ModuleInfo: Module: usLexer InitialContents: FollowSlot\x7fVisibility: public'
        
         directory <- 'applications/allUs/usParser'.
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'usLexer' -> () From: ( | {
         'ModuleInfo: Module: usLexer InitialContents: InitializeToExpression: (_CurrentTimeString)\x7fVisibility: public'
        
         fileInTimeString <- _CurrentTimeString.
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'usLexer' -> () From: ( | {
         'ModuleInfo: Module: usLexer InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'usLexer' -> () From: ( | {
         ...
         subpartNames <- 'usLexerTokens'.
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> () From: ( | {
         'Category: lexing\x7fModuleInfo: Module: usLexer InitialContents: FollowSlot\x7fVisibility: public'
        
         characterSets = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'usParser' -> 'characterSets' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals usParser characterSets.
'.
            | ) .
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> () From: ( | {
         ...
         lexer = bootstrap define: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'parent' From:
             bootstrap remove: 'spaces' From:
             bootstrap remove: 'tokenTraits' From:
             bootstrap remove: 'tokens' From:
             globals parseKit lexer copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> () From: ( |
             {} = 'Comment: To make your lexer,
create a copy-down child of
this object and replace the contents of the spaces 
and tokens slots. -- dmu 8/99\x7fModuleInfo: Creator: globals usParser lexer.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> () From: ( | {
         'ModuleInfo: Module: usLexer InitialContents: InitializeToExpression: (0)\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> () From: ( | {
         ...
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals usParser lexer parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> 'parent' -> () From: ( | {
         'Category: nesting\x7fModuleInfo: Module: usLexer InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> 'parent' -> () From: ( | {
         'Category: nesting\x7fModuleInfo: Module: usLexer InitialContents: FollowSlot\x7fVisibility: public'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> 'parent' -> () From: ( | {
         'Category: testing\x7fModuleInfo: Module: usLexer InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> () From: ( | {
         'Category: change these to lex your language\x7fModuleInfo: Module: usLexer InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> () From: ( | {
         ...
         tokenTraits = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> 'tokenTraits' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals usParser lexer tokenTraits.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> 'tokenTraits' -> () From: ( | {
         'ModuleInfo: Module: usLexer InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> () From: ( | {
         ...
         tokens = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'usParser' -> 'lexer' -> 'tokens' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals usParser lexer tokens.
'.
            | ) .
        } | ) 
 ...
 bootstrap read: 'usLexerTokens' From: 'applications/allUs/usParser'



 '-- Side effects'

 globals modules usLexer postFileIn
