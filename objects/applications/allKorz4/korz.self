...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'abstractContext' -> 'parent' -> () From: ( | {
         ...
         send: selector = ( |
            | [qqq]. korz operations send: selector ToContext: self).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ast' -> 'declaration' -> () From: ( | {
         'ModuleInfo: Module: korz InitialContents: InitializeToExpression: (korz ast declaration)'
        
         contentsDcl <- bootstrap stub -> 'globals' -> 'korz' -> 'ast' -> 'declaration' -> ().
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ast' -> 'declaration' -> 'parent' -> () From: ( | {
         ...
         evaluateContentsDclInContext: ctx = ( |
            | 
            contentsDcl evaluateInContext: ctx).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ast' -> 'method' -> 'parent' -> () From: ( | {
         ...
         copyForMethodDefinitionParseTree: parseTree Selector: sel Guard: g IfFail: fb = ( |
            | 
            [unifyDataAndMethodSlotsFormalsSomeday].
            (
              ...
              initForGuard: g Formals: parseTree formalParseNodes IfFail: fb).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ast' -> 'method' -> 'parent' -> () From: ( | {
         ...
         initForGuard: guard Formals: formalParseNodesFromSlotDeclaration IfFail: fb = ( |
             method.
            ...
            addAllASTFormalsInGuard: guard IfFail: [|:e| ^ fb value: e].

            ifExplicitArgumentIn: formalParseNodesFromSlotDeclaration
                  AppearsInGuard: guard Do: [|:e| ^ fb value: e]. 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ast' -> 'methodDeclaration' -> 'parent' -> () From: ( | {
         ...
         copyAndEvaluateParseTreeForEvaluatorContents: parseTree In: aContext ReportErrorsTo: aResultReporter = ( |
             ast.
             r.
             slot.
            | 
            ...
            ast: copyForEvaluatorContentsParseTree: parseTree 
                       ...
                       aResultReporter reportError: (((traits string parseErrorPt copy start: 0@0) end: parseTree source size@0) message: x)
                                             Title: 'error converting parseTree to AST'.
                                                     ^ aFacet].
            slot: korz slots methodSlot copyForAST: ast EnclosingObject: aContext receiverFacet In: aContext.
            r: slot evaluateInContext:  aContext.
            slot vaporize.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ast' -> 'methodDeclaration' -> 'parent' -> () From: ( | {
         ...
         initContentsIfFail: fb = ( |
            | 
            parseTree assignmentAndValueIfPresent: [|:a. :v|
              contentsDcl: korz ast method copyForMethodDefinitionParseTree: parseTree 
                                                                   Selector: parseTree selectorString 
                                                                      Guard: guard 
                                                                     IfFail: [|:e| ^ fb value: e]
            ]
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ast' -> 'methodDeclaration' -> 'parent' -> () From: ( | {
         ...
         initFromParseTreeForEvaluatorContents: parseTree IfFail: fb = ( |
            | 
            name: 'do_it'.
            contentsDcl: korz ast method copyForEvaluatorContentsParseTree: parseTree IfFail: [|:e| ^ fb value: e]).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ast' -> 'object' -> 'parent' -> () From: ( | {
         ...
         copyAndEvaluateParseTreeForEvaluatorContents: parseTree In: aContext ReportErrorsTo: aResultReporter = ( |
            ...
            ast setInitializersIn: aContext IfNLR: [|:r|  aResultReporter syntaxError: errPt message: 'NLR in initializer'. ^ aFacet].
            aResultReporter result: ast evaluateInContext: aContext.
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'operations' -> () From: ( | {
         ...
         sendNonPrimitive: selector ToContext: aContext = ( |
            ...
            ctx: aContext copy.
            ctx assertNoNils.
            slot: korz multidispatchLookup lookup: selector In: ctx.
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'slots' -> 'abstractSlot' -> 'parent' -> () From: ( | {
         ...
         copyForAST: ast EnclosingObject: eoOrNil In: aContext = ( |
            | 
            (copy initForAST: ast EnclosingObject: eoOrNil In: aContext) supercedeCompetingSlots).
        } | ) 
