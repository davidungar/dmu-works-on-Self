...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         asList = ( |
            | (list copyRemoveAll addAll: usParentSlots) addAll: usParentFacets).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         fakeSlotParentSlotsDo: blk = ( |
            | 
            usParentSlots asVector do: [|:slot. :i| 
              blk value:  us ide slotParentFakeSlot copySlot: slot In: self]).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         oneOfEachFakeSlot = ( |
            | 
            (list copyRemoveAll add: us ide facetParentFakeSlot) add: us ide slotParentFakeSlot).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'facetParentFakeSlot' -> 'parent' -> () From: ( | {
         ...
         annotation = ( |
            | 
            slotAnnotation parse: 'Category: Parents').
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> () From: ( | {
         ...
         pseudoSlotModel = bootstrap define: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'pseudoSlotModel' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'parent' From:
             globals generalSlotModel copyForSpecialization ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'pseudoSlotModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals us ide pseudoSlotModel.
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'pseudoSlotModel' -> () From: ( | {
         'ModuleInfo: Module: usMorphs InitialContents: FollowSlot\x7fVisibility: private'
        
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'pseudoSlotModel' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals us ide pseudoSlotModel parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'pseudoSlotModel' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: usMorphs InitialContents: FollowSlot'
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> () From: ( | {
         ...
         slotParentFakeSlot = bootstrap define: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'slotParentFakeSlot' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'parent' From:
             globals us ide abstractFakeSlot copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'slotParentFakeSlot' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals us ide slotParentFakeSlot.
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'slotParentFakeSlot' -> () From: ( | {
         'ModuleInfo: Module: usMorphs InitialContents: FollowSlot'
        
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'slotParentFakeSlot' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals us ide slotParentFakeSlot parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'slotParentFakeSlot' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: usMorphs InitialContents: FollowSlot'
        
         annotation = ( |
            | 
            slotAnnotation parse: 'Category: Slots').
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'ide' -> 'slotSliceGroupModel' -> 'parent' -> () From: ( | {
         ...
         titleString = ( |
            | 
            'Us slots with a common receiver').
        } | ) 
