...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         checkAllFormals = ( |
            | 
            usParentSlots do: [|:s| s checkFormals].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         copy = ( |
            ...
            r usParentSlots: usParentSlots copyMappedBy: [|:s| s fixupAfterChildFacet: self WasCopiedTo: r].
            checkAllFormals.
            r checkAllFormals.
            r).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'formal' -> 'parent' -> () From: ( | {
         ...
         fixupAfterChild: oldChild OfMyDataSlotWasCopiedTo: newChild = ( |
             r.
            | 
            "maybe could return self if oldChild not in childFacets?"
            r: copy.
            r childFacets remove: oldChild IfAbsent: [^r].
            r childFacets add: newChild.
            r).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'formal' -> 'parent' -> () From: ( | {
         ...
         fixupAfterChild: oldChild OfMyMethodSlotWasCopiedTo: newChild = ( |
            | 
            (childFacets includes: oldChild) ifTrue: [childFacets add: newChild].
            self).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         addNewSibling: newFacet PossiblyReplacingOldSibling: oldFacet = ( |
            | 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         fixupAfterChildFacet: oldChild WasCopiedTo: newChild = ( |
            | 
            formals do: [|:f| f fixupAfterChild: oldChild OfMyMethodSlotWasCopiedTo: newChild].
            self).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'dataSlot' -> 'parent' -> () From: ( | {
         ...
         ensureOtherFacetsIInheritFromInheritMe = ( |
            | 
            formals do: [|:fo| fo childFacets do: [|:fa| fa usParentSlots add: self]].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'dataSlot' -> 'parent' -> () From: ( | {
         ...
         fixupAfterChildFacet: oldChild WasCopiedTo: newChild = ( |
             r.
            | 
            "data slot may have already been copied, need to make only one copy"
            (isDispatchedOn: oldChild) ifFalse: [halt. ^self].
            r: copy.
            r formals: r formals copyMappedBy: [|:f| f fixupAfterChild: oldChild OfMyDataSlotWasCopiedTo: newChild].
            r ensureOtherFacetsIInheritFromInheritMe.
            r).
        } | ) 
