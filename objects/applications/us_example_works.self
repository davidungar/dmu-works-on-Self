...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'context' -> 'parent' -> () From: ( | {
         ...
         slotsAndDistancesByFacetNameNamed: selector = ( |
            ...
            forAllArgumentsDo: [|:facet. :argName. listOfSlotsAndDistances|
              listOfSlotsAndDistances: facet getSlotsAndDistancesWithSelector: selector ThatDispatchOnMeWhenIAmNamed: argName.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'context' -> 'parent' -> () From: ( | {
         ...
         trimAllLessSpecificSlotsFrom: distancesByNameBySlot Selector: selector = ( |
            ...
            dByNByS do: [|:dByN1. :s1. |
              dByNByS do: [|:dByN2.  :s2|
                compare: dByN1 To: dByN2 IfLess: [ halt. results remove: s2 ]  Equal: []  Greater: [ halt. results remove: s1 ] Incomparable: []
              ]
            ].
            results).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'examples' -> 'bankAccount' -> () From: ( | {
         ...
         makeBalance = ( |
            ...
            b addFormal: ((us formal copy formalName:  us context positionalFacetNameAt: 1) isImplicit: false) dispatchOn: us facets abstractNumber.
            self).
        } | ) 
            ...
            b: (us slots slot copy selector: 'deposit')
              implementation: (| 
                ...
                evaluateInContext: ctx  = ( 
                  ...
                  addCtx positionalFacetAt: 2 Put: ctx positionalFactAt: 1.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'examples' -> 'bankAccount' -> () From: ( | {
         ...
         testBalanceInProtoAccount = ( |
             b.
            | 
            setBalanceOf: protoAccount To: 17 asUsObject.  b: getBalanceOf: protoAccount.  17 = b asSelfObject ifFalse: [halt].
            setBalanceOf: protoAccount To:  0 asUsObject.  b: getBalanceOf: protoAccount.   0 = b asSelfObject ifFalse: [halt].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'examples' -> 'bankAccount' -> () From: ( | {
         ...
         testDepositInProtoAccount = ( |
             b.
            | 
            b: getBalanceOf: protoAccount.   0 = b asSelfObject ifFalse: [halt].
            sendDepositTo:   protoAccount With: 17 asUsObject.
            b: getBalanceOf: protoAccount.   17 = b asSelfObject ifFalse: [halt].
            self).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         addUsParentSlot: aFormal = ( |
            | 
            [aFormal selector != ''] assert.
            usParentSlots add: aFormal. self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         copy = ( |
            ...
            | 
            r: resend.copy.
            r copyDataParentSlotsChangingFacetFrom: self To: r.
            r usParentFacets: usParentFacets copy.
            r usParentSlots do: [|:ps| ps addNewSibling: r ToOldSibling: self].
            r).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         copyDataParentSlotsChangingFacetFrom: oldFacet To: newFacet = ( |
            | 
            usParentSlots: usParentSlots copyMappedBy: [|:s| s copyIfDataSlotChangingFacetFrom: oldFacet To: newFacet]).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         getSlotsAndDistancesWithSelector: selector ThatDispatchOnMeWhenIAmNamed: argName = ( |
             r <- list copyRemoveAll.
             slots <- set copyRemoveAll.
            | 
            r: list copyRemoveAll.
            slots: usParentSlots copyFilteredBy: [|:s| s isNamed: selector AndDispatchesOnFacet: self WhenFacetIsNamed: argName].
            r addAll: slots copyMappedBy: [|:s| s @ 0].
            usParentFacets do: [|:pf| 
              r addAll: 
                (pf getSlotsAndDistancesWithSelector: selector ThatDispatchOnMeWhenIAmNamed: argName)
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> 'parent' -> () From: ( | {
         'Comment: returns a vector of lists of slots by distance\x7fModuleInfo: Module: us InitialContents: FollowSlot'
         ...
         lookup: selector WithArguments: args Into: aVector Distance: d = ( |
            ...
            v at: d Put:
              usParentSlots copyFilteredBy: [|:aSlot| aSlot matchesSelector: selector Arguments: args].
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facet' -> () From: ( | {
         ...
         usParentSlots <- set copyRemoveAll.
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'facets' -> () From: ( | {
         ...
         testPlus = ( |
             c.
            | 
            [us facets abstractNumber usParentSlots size = 2] assert.
            c: us context copy.
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'formal' -> 'parent' -> () From: ( | {
         ...
         copyIfNeededToChangeFacetFrom: old To: new = ( |
             r.
            | 
            (childFacets includes: old) ifFalse: [^self].
            r: copy.
            r childFacets remove: old.
            r childFacets add: new.
            r).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'formal' -> 'parent' -> () From: ( | {
         ...
         isDispatchedOnFacet: aFacet Named: aName = ( |
            | 
            (isDispatchedOn: aFacet) && [aName = formalName]).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'formal' -> 'parent' -> () From: ( | {
         ...
         statePrintString = ( |
            | 
            formalName, ' = ', childFacets printString).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         addFormal: aFormal = ( |
            ...
            aFormal isDispatched ifTrue: [
              aFormal childFacets do: [|:f| f addUsParentSlot: self].
            ].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         addMeInToDispatchedFormalsUsParentSlots = ( |
            ...
            dispatchedFormals do: [|:f|  
              f childFacets do: [|:cf| cf addUsParentSlot: self].
            ].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         addNewSibling: newFacet ToOldSibling: oldFacet = ( |
            | 
            formals do: [|:f| (f isDispatchedOn: oldFacet) ifTrue: [f childFacets add: newFacet]].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         isNamed: aSelector AndDispatchesOnFacet: aFacet WhenFacetIsNamed: argName = ( |
            | 
            selector = aSelector ifFalse: [^ false].
            formals findFirst: [|:f| f isDispatchedOnFacet: aFacet Named: argName]
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         makeMinusSlot = ( |
            ...
            |).
            s addFormal: ((us formal copy formalName:  us context positionalFacetNameAt: 1) isImplicit: false) dispatchOn: us facets abstractNumber.
            s addFormal: ((us formal copy formalName:  us context positionalFacetNameAt: 2) isImplicit: false) dispatchOn: us facets abstractNumber).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         matchesSelector: s Arguments: args = ( |
            | 
            selector = s).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         receiverFacet: x = ( |
            | 
            addFormal: ((us formal copy formalName: us context receiverName) isImplicit: true) dispatchOn: x.
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'slot' -> 'parent' -> () From: ( | {
         ...
         timeFacet: x = ( |
            | 
            addFormal: ((us formal copy formalName: us context timeName) isImplicit: true) dispatchOn: x.
            self).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'dataSlot' -> 'parent' -> () From: ( | {
         ...
         copyIfDataSlotChangingFacetFrom: old To: new = ( |
            | 
            (copy formals: formals copyMappedBy: [|:f| f copyIfNeededToChangeFacetFrom: old To: new]) addMeInToDispatchedFormalsUsParentSlots).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'dataSlot' -> 'parent' -> () From: ( | {
         ...
         isNamed: aSelector AndDispatchesOnFacet: aFacet WhenFacetIsNamed: argName = ( |
            | 
                  resend.isNamed: (aSelector last = ':' ifTrue: [aSelector copyWithoutLast] False: [aSelector])
            AndDispatchesOnFacet: aFacet 
                WhenFacetIsNamed: argName).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'us' -> 'slots' -> 'dataSlot' -> 'parent' -> () From: ( | {
         ...
         matchesSelector: s Arguments: args = ( |
            | 
            (resend.matchesSelector: s Arguments: args) ||
            [ args isEmpty not && [ resend.matchesSelector: s copyWithoutLast Arguments: args asVector copyWithoutFirst]]).
        } | ) 
