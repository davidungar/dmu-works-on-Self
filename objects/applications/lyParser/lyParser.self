...
'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> () From: ( | {
         ...
         lyParser = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'lyParser' -> () From: ( |
             {} = 'Comment: To test: run lyParser tester testAll\x7fModuleInfo: Creator: globals lyParser.
'.
            | ) .
        } | ) 
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'lyParser' -> () From: ( | {
         'Category: state\x7fModuleInfo: Module: lyParser InitialContents: InitializeToExpression: (\'
Copyright 2007-2013 IBM.
See the LICENSE file for license information.
