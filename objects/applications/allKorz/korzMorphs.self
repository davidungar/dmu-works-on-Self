...
'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         fakeParentFacetSlotsDo: blk = ( |
            ...
            korzParentFacets asVector do: [|:facet. :i| 
              blk value:  korz ide facetParentFakeSlot copyForContainer: self Parent: facet]).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         oneOfEachFakeSlot = ( |
            ...
            korzParentFormals isEmpty ifFalse: [ r add: korz ide slotPretendingToBeInFacet].
            r).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'facet' -> 'parent' -> () From: ( | {
         ...
         slotsPretendingToBeInMeDo: blk = ( |
            | (korz ide slotPretendingToBeInFacet copyForAllFormalsIn: self) do: blk).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         'Category: building\x7fCategory: each formal\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
        
         addChildFacetOf: aFormal IfAnyTo: m = ( |
            | 
            aFormal childFacets isEmpty ifFalse: [ addChildFacetOf: aFormal To: m].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         ...
         addChildFacetOf: aFormal To: m = ( |
            | 
            m addMorphLast: labelMorphLabeled: dimensionCoordinateSeparator.
            m addMorphLast:  
              korz ide formalPushButton copyFormal: aFormal 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         ...
         addContentsOf: aFormal To: aMorph = ( |
            | 
            addChildFacetOf: aFormal IfAnyTo: aMorph).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         ...
         addFormal: aFormal To: m = ( |
            ...
            addContentsOf: aFormal To: m.

            self).
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         'Category: building\x7fCategory: implicit formals\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         'Category: building\x7fCategory: simplifying\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         'Category: building\x7fCategory: whole enchilada\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         'Category: building\x7fCategory: each formal\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         'Category: building\x7fCategory: styles\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         'Category: building\x7fCategory: implicit formals\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> () From: ( | {
         'Category: building\x7fCategory: helpers\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> () From: ( | {
         'Category: morphs\x7fCategory: others\x7fCategory: debugging\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: public'
        
         selectorFormalsAndActualsMorph = bootstrap define: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'parent' From:
             globals korz ide selectorAndFormalsMorph copyRemoveAllMorphs ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide selectorFormalsAndActualsMorph.

CopyDowns:
globals korz ide selectorAndFormalsMorph. copyRemoveAllMorphs 
SlotsToOmit: parent.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
        
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide selectorFormalsAndActualsMorph parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> 'parent' -> () From: ( | {
         ...
         addActualValueOf: aFormal To: m = ( |
             obj.
            | 
            [aFormal name = aFormal formalName ] assert. "which one?"
            obj: slot incomingContext arguments at: aFormal formalName IfAbsent: [
              [slot selector = 'do_it'] assert. "ugh!"
              korz facets foyer
            ].
            m addMorphLast: 
              (aFormal childFacets size  =  1)  &&  [aFormal childFacets first  ==  obj] ifTrue: [
                labelMorphLabeled: ' == '
              ]
              False: [
                korz ide facetPushButton copyFacet: obj Style: facetStyle.
              ].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> 'parent' -> () From: ( | {
         ...
         addContentsOf: aFormal To: m = ( |
            | 
            addActualValueOf: aFormal To: m.
            resend.addContentsOf: aFormal To: m).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> 'parent' -> () From: ( | {
         ...
         buildLinearTitle = ( |
            | 
            buildTitleIsFolded: false).
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
        
         buildTitleIsFolded: isFolded = ( |
             outerColumn.
             selectorFormalsAndGuardedActuals.
             unguardedActuals.
             unguardedActualsRow.
            | 
            selectorFormalsAndGuardedActuals: isFolded ifTrue: resend.buildFoldedTitle False: resend.buildLinearTitle.
            unguardedActuals: buildUnguardedActuals.
            unguardedActuals isEmpty ifTrue: [^selectorFormalsAndGuardedActuals].

            unguardedActualsRow: selectorFormalsAndGuardedActuals copyRemoveAllMorphs.
            unguardedActuals do: [|:a| unguardedActualsRow addMorphLast: a].

            outerColumn: columnMorph copy beShrinkWrapHorizontally beFlexibleVertically leftJustify borderWidth: 0.
            outerColumn addMorphLast: unguardedActualsRow.
            outerColumn addMorphLast:selectorFormalsAndGuardedActuals.
            outerColumn).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> 'parent' -> () From: ( | {
         ...
         buildUnguardedActuals = ( |
             r.
             ua.
            | 
            r: list copyRemoveAll.
            ua: activation unguardedActualsAsSortedPoints.
            ua isEmpty ifTrue: [^ r].
            r add: labelMorphLabeled: '{ '.
            [|:exit. a|
              a: ua removeFirst.
              r add: labelMorphLabeled: a x, ' => '.
              r add: korz ide facetPushButton copyFacet: a y Style: facetStyle.
              ua isEmpty ifTrue: exit.
              r add: labelMorphLabeled: '. '
            ] loopExit.
            r add: labelMorphLabeled: ' }'.
            r).
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> 'parent' -> () From: ( | {
         ...
         parent* = bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorAndFormalsMorph' -> 'parent' -> ().
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> () From: ( | {
         'Category: morphs\x7fCategory: others\x7fCategory: debugging\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: public'
        
         blockSelectorFormalsAndActualsMorph = bootstrap define: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'blockSelectorFormalsAndActualsMorph' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'parent' From:
             globals korz ide selectorFormalsAndActualsMorph copyRemoveAllMorphs ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'blockSelectorFormalsAndActualsMorph' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide blockSelectorFormalsAndActualsMorph.

CopyDowns:
globals korz ide selectorFormalsAndActualsMorph. copyRemoveAllMorphs 
SlotsToOmit: parent.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'blockSelectorFormalsAndActualsMorph' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
        
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'blockSelectorFormalsAndActualsMorph' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide blockSelectorFormalsAndActualsMorph parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'blockSelectorFormalsAndActualsMorph' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
         ...
         buildTitle = ( |
            ...
            c: (columnMorph copy beShrinkWrap color: color)   leftJustify borderWidth: 0.
            r: (   rowMorph copy beShrinkWrap color: color)    topJustify borderWidth: 0.

            r addMorphLast: labelMorphLabeled: 'in: '.
            r addMorphLast: korz ide selectorFormalsAndActualsMorph copyFor: slot outermostLexicalScope ImplicitFacet: implicitFacetOrNil.
            c addMorphLast: r.
            c addMorphLast: spacerMorph copyV: 4 Color: color.
            c addMorphLast: resend.buildTitle.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'blockSelectorFormalsAndActualsMorph' -> 'parent' -> () From: ( | {
         ...
         parent* = bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'selectorFormalsAndActualsMorph' -> 'parent' -> ().
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotModel' -> 'parent' -> () From: ( | {
         'Category: building\x7fCategory: header\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
        
         addDismissButtonToHeader = ( |
            | 
            korz ide isSimplified ifTrue: [^ self].
            resend.addDismissButtonToHeader).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotModel' -> 'parent' -> () From: ( | {
         ...
         buildSlotTitle = ( |
            | 
            myOutliner titleEditor: (titleEditorPrototype copyFor: mirror ImplicitFacet: facetContainingMe) colorAll: myOutliner color.
...
deal with the ancilliary info. -- dmu 6/1\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: public'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotModel' -> 'parent' -> () From: ( | {
         ...
         facetContainingMe = bootstrap stub -> 'globals' -> 'nil' -> ().
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotModel' -> 'parent' -> () From: ( | {
         ...
         methodText = ( |
            | 
            korz ide korzFormattingMethodText).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotModel' -> 'parent' -> () From: ( | {
         ...
         outlinerForSprouting: evt IfNone: nb = ( |
            | 
            ifCannotSprout: [^ nb value] Event: evt.

                   hasMethod
            || [ |j|   j: myOutliner expander target joineeOrNil. (j isNotNil  && [j model referrent isKorzSlot] )
            || [  evt isShiftDownForLeftShiftHack ] ]
              ifTrue: [ outlinerForSproutingSlot ] False: [outlinerForSproutingFacet]).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotModel' -> 'parent' -> () From: ( | {
         'Category: copying & creating\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
...
-- Ungar, 2/4/95\x7fModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: public'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotModel' -> 'parent' -> () From: ( | {
         ...
         sprout: evt = ( |
            | 
            case
              if:  ( evt isShiftDownForLeftShiftHack )   Then: [  myOutliner sproutWithArrow: evt  ]
              If:  [ hasMethod not                   ]   Then: [  myOutliner sproutWithArrow: evt  ]
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> () From: ( | {
         ...
         contributeToBackgroundMenu: m = ( |
            ...
            m addButton:
                ( ( ui2Button copy
                   scriptBlock: [ korz ide optionsMenu copy popUp: event] )
                   label: 'Korz options' )
            ToGroup: 'applications'.
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetModel' -> 'parent' -> () From: ( | {
         ...
         headerButtonContents = ( |
            | 
            korz ide isSimplified ifTrue: [^ vector].
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetParentFakeSlot' -> 'parent' -> () From: ( | {
         ...
         annotation = ( |
            | 
            slotAnnotation parse: 'Category: Parent Coordinates').
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetParentFakeSlot' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot'
        
         copyForContainer: cf Parent: pf = ( |
            | 
            (copy facetContainingMe: cf ) parentFacet: pf).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetParentFakeSlot' -> 'parent' -> () From: ( | {
         ...
         exists = ( |
            | 
            facetContainingMe hasParentFacet: parentFacet).
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> () From: ( | {
         ...
         facetPushButton = bootstrap define: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetPushButton' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'mirror' From:
             bootstrap remove: 'parent' From:
             bootstrap remove: 'prototype' From:
             globals objectPushButton copyRemoveAllMorphs ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetPushButton' -> () From: ( |
             {} = 'Comment: Do not use me!!
Use ui2Button instead.\x7fModuleInfo: Creator: globals korz ide facetPushButton.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetPushButton' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: InitializeToExpression: (korz  facet copy)'
        
         facet <- korz  facet copy.
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetPushButton' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
        
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetPushButton' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide facetPushButton parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetPushButton' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: public'
        
         copyFacet: f Style: aFontSpec = ( |
            | 
            copy initFacet: f Style: aFontSpec).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'facetPushButton' -> 'parent' -> () From: ( | {
         ...
         morphTypeName = 'korzIDEFacetPushButton'.
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> () From: ( | {
         ...
         formalPushButton = bootstrap define: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'formalPushButton' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'mirror' From:
             bootstrap remove: 'parent' From:
             bootstrap remove: 'prototype' From:
             globals objectPushButton copyRemoveAllMorphs ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'formalPushButton' -> () From: ( |
             {} = 'Comment: Do not korze me!!
Korze ui2Button instead.\x7fModuleInfo: Creator: globals korz ide formalPushButton.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'formalPushButton' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: InitializeToExpression: (nil)'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'formalPushButton' -> () From: ( | {
         ...
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'formalPushButton' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide formalPushButton parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'formalPushButton' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'formalPushButton' -> 'parent' -> () From: ( | {
         ...
         morphTypeName = 'korzIDEFormalPushButton'.
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'formalPushButton' -> 'parent' -> () From: ( | {
         ...
         name = ( |
            ...
            ifTrue: (korz ide isSimplified ifTrue: '<this coord>' False: '  ')
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> () From: ( | {
         'Comment: for figures and maybe demos\x7fModuleInfo: Module: korzMorphs InitialContents: InitializeToExpression: (false)\x7fVisibility: public'
        
         isSimplified <- bootstrap stub -> 'globals' -> 'false' -> ().
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'korzActivationMethodText' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
        
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'korzActivationMethodText' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide korzActivationMethodText parent.
'.
            | ) .
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> () From: ( | {
         ...
         korzFormattingMethodText = bootstrap define: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'korzFormattingMethodText' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'parent' From:
             globals selfMethodText copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'korzFormattingMethodText' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide korzFormattingMethodText.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'korzFormattingMethodText' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
        
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'korzFormattingMethodText' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide korzFormattingMethodText parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'korzFormattingMethodText' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: korzMorphs InitialContents: FollowSlot\x7fVisibility: private'
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> () From: ( | {
         ...
         slotPretendingToBeInFacet = bootstrap define: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotPretendingToBeInFacet' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'parent' From:
             globals korz ide abstractFakeSlot copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotPretendingToBeInFacet' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide slotPretendingToBeInFacet.
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotPretendingToBeInFacet' -> () From: ( | {
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotPretendingToBeInFacet' -> () From: ( | {
         ...
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotPretendingToBeInFacet' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz ide slotPretendingToBeInFacet parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotPretendingToBeInFacet' -> 'parent' -> () From: ( | {
         ...
         copyForAllFormalsIn: facet = ( |
            ...
            facet parentFormalsBySlotFilteredBy: [|:f| true "f isNotPositional"])
              copyMappedBy: [|:formals. :slot|
                (copy facetContainingMe: facet) consolidatedFormals: formals
              ]
            ) asList).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'ide' -> 'slotPretendingToBeInFacet' -> 'parent' -> () From: ( | {
         ...
         existsInChildFacetOfFormals = ( |
            ...
            facetContainingMe ifNil: [^ false].
            consolidatedFormals findFirst: [|:f| (facetContainingMe hasParentFormal: f) not]
                    IfPresent: false
                     IfAbsent: true).
        } | ) 
...
'.
 ...
 bootstrap read: 'korzOptionsMenu' From: 'applications/allKorz'
