...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'selfProcessStackModel' -> () From: ( | {
         'Category: processStackModel state\x7fComment: Have to add explicitly because copy-down does not work since
this slot is added AFTER the module that copies this down has been read.\x7fModuleInfo: Module: korzSelfDebugger InitialContents: InitializeToExpression: (nil)\x7fVisibility: private'
