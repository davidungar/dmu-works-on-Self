...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'multidispatchLookup' -> 'parent' -> 'defaultFailBlock' -> 'parent' -> () From: ( | {
         ...
         value = ( |
             coe.
             debugKorzDebugger = bootstrap stub -> 'globals' -> 'true' -> ().
             p.
             pp.
            | 
            ...
            debugKorzDebugger ifTrue: [error: errorMsg "for debugging debugger"].
            p suspend.
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'multidispatchLookup' -> 'parent' -> () From: ( | {
         ...
         messageAmbiguousError = ( |
            | 
            handleError: '\'', selector, '\' is ambigous, has ', mostSpecificSlots size printString, ' equally specific slots'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'multidispatchLookup' -> 'parent' -> () From: ( | {
         ...
         messageNotUnderstoodError = ( |
            | 
            handleError: '\'', selector, '\' not understood'
            NumberOfMatches: 0).
        } | ) 
