...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'morph' -> () From: ( | {
         'Category: damage management\x7fModuleInfo: Module: davidHacks InitialContents: FollowSlot\x7fVisibility: public'
         ...
         changed = ( |
            ...
            ["+- 2 fudge added for" quartz].
            damagedLeft: (bnds left   floor - p x) - 2
                  Right: (bnds right  ceil  - p x) + 2
                    Top: (bnds top    floor - p y) - 2
                 Bottom: (bnds bottom ceil  - p y) + 2
                   From: self.
            self).
        } | ) 
