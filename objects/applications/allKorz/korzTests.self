...
'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> () From: ( | {
         'ModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: public'
        
         tests = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz tests.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> () From: ( | {
         'ModuleInfo: Module: korzTests InitialContents: FollowSlot'
        
         bankAccount = ( |
            | korz worldMaker bankAccount make).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> () From: ( | {
         ...
         buttons = ( |
            | 
            korz ide facetModel getFoyerFacetEvent: process this birthEvent).
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> () From: ( | {
         'ModuleInfo: Module: korzTests InitialContents: FollowSlot'
        
         ide = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz tests ide.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> () From: ( | {
         'ModuleInfo: Module: korzTests InitialContents: InitializeToExpression: (nil)'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> () From: ( | {
         ...
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korz tests ide parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: korz-level ops\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: locations\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
        
         backgroundMenuLocation = (100)@(100).
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: evaluating\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: interactions\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: interactions\x7fCategory: outliners\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: editing (slots)\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: interactions\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: evaluating\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         ...
         evaluate: exprString In: facetName Ensuring: testBlock = ( |
             m.
            | 
            facetName = korz facets foyerName ifFalse: [unimp: 'must get it and go there'].
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: finding morphs\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: interactions\x7fCategory: finding editors\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
        
         findEvaluatorEditorIn: aMorph AndType: aString = ( |
             e.
            | 
            e: findMorphIn: aMorph Type: korz ide korzEvaluatorEditor morphTypeName.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: finding morphs\x7fCategory: finding morphs\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: finding morphs\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: interactions\x7fCategory: buttoning\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: korz-level ops\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot'
        
         makeCloneAndCopySlots = ( |
             o.
            | 
            o: evaluate: '(| { rcvr => foyer :: clone = (_CopyKorzFacet).  copy = (clone) } |)' 
            In: 'foyer'
            Ensuring: true).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         ...
         makeFacetNamed: n InheritingFrom: parentName PlaceAt: dropPt = ( |
             ...
             queryMorphEditor.
            | 
            parentName = korz facets foyerName ifFalse: [error: 'unimp'].
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         ...
         makeMultiplySlot = ( |
            | 
            evaluate: '(| 
              { rcvr => abstractNumber  :: * { a => abstractNumber } = (\'*\' __SendTo: rcvr With: a). }
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: events\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: events\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: interactions\x7fCategory: buttoning\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'ModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
        
         run = ( |
             t.
            | 
            [ !== korz tests ide ] assert. "should be a copy"
            t: korz facets foyerName.
            korz worldMaker core make.
            openWorld.

            getFoyerFacet.
            testSproutingSlot: korz facets nilName In: foyerFacetOutliner.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: interactions\x7fCategory: sprouting\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: private'
         ...
         sproutSlot: name In: aFacetOutliner = ( |
            ...
            waitForMorphToStop: findMorphType: 'korzIDESlotOutliner').
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: more tests\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot'
        
         testArithmetic = ( |
            | 
            [makeMultiplySlot. ].
            evaluate: '3 * 4' In: korz facets foyerName Ensuring: [|:aFacet| aFacet asSelfObject == 7].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         ...
         testSimpleSlotCreation = ( |
            ...
            | 
            t: korz facets foyerName.
            evaluate: '()'               In: t Ensuring: [|:aFacet|  aFacet isKorzFacet].
            evaluate: '(|a        |)'    In: t Ensuring: [|:aFacet|  aFacet isKorzFacet].
            evaluate: '(|a =  3   |)'    In: t Ensuring: [|:aFacet|  aFacet isKorzFacet].
            evaluate: '(|a <- 4   |)'    In: t Ensuring: [|:aFacet|  aFacet isKorzFacet].
            evaluate: '(|a <- ()  |)'    In: t Ensuring: [|:aFacet|  aFacet isKorzFacet].
            evaluate: '(|a =  ()  |)'    In: t Ensuring: [|:aFacet|  aFacet isKorzFacet].
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'tests' -> 'ide' -> 'parent' -> () From: ( | {
         'Category: editing (slots)\x7fModuleInfo: Module: korzTests InitialContents: FollowSlot'
        
         testWholeSlotEditMenuButton = ( |
             e.
             expr.
             s = '{ rcvr -> foyer :: copy = ( \"test\" clone ) }'.
             slotOutliner.
             ss = 'copy = ( \"test\" clone )'.
            | 
            slotOutliner: sproutSlot: 'copy' In: foyerFacetOutliner.
            editWholeThing: s  In: slotOutliner.
            [slotOutliner model slot ast parseTree source  =  ss] assert.
            slotOutliner delete.
            self).
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> () From: ( | {
         ...
         korzTests = bootstrap define: bootstrap stub -> 'globals' -> 'modules' -> 'korzTests' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals modules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'modules' -> 'korzTests' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals modules korzTests.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'korzTests' -> () From: ( | {
         'ModuleInfo: Module: korzTests InitialContents: FollowSlot\x7fVisibility: public'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'korzTests' -> () From: ( | {
         'ModuleInfo: Module: korzTests InitialContents: InitializeToExpression: (_CurrentTimeString)\x7fVisibility: public'
...
'.
 ...
 bootstrap read: 'korzDemos' From: 'applications/allKorz'



 '-- Side effects'

 globals modules korzTests postFileIn
