...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'worldMaker' -> 'identityE' -> 'korzStyleBroken' -> () From: ( | {
         ...
         makeAbstractObjects = ( |
            | 
            addMySlots: ' ieoo_person = (). state = (). company = (). man = (). woman = ()').
        } | ) 
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'worldMaker' -> 'identityE' -> 'ooStyle' -> () From: ( | {
         ...
         makeAbstractObjects = ( |
            | 
            addMySlots: ' ieoo_person = (). state = (). company = ()'.
            addMySlots: ' man = (|parent* = ieoo_person|). woman = (|parent* = ieoo_person|).').
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korz' -> 'worldMaker' -> 'identityE' -> 'ooStyle' -> () From: ( | {
         ...
         makeSalutationMethod = ( |
            | 
            addMySlots: '{ rcvr => ieoo_person :: salutation = ( state salutationFor: rcvr ) }'.
            addMySlots: '{ rcvr => state  :: salutationFor: person = ( person formalSalutation ) }'.
            addMySlots: '{ rcvr => ieoo_person :: formalSalutation = ( hasPhD ifTrue: [\'Dr.\'] False: [mrOrMs] ) }'.
