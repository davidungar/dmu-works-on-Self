...
'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> () From: ( | {
         'Category: lexing\x7fModuleInfo: Module: korzLexer InitialContents: FollowSlot\x7fVisibility: public'
        
         characterSets = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korzParser' -> 'characterSets' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korzParser characterSets.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'characterSets' -> () From: ( | {
         'ModuleInfo: Module: korzLexer InitialContents: FollowSlot\x7fVisibility: public'
        
         identifierLetter = (('A' asCharacterSet  =>  'Z') + ('a' asCharacterSet  =>  'z')) + ('_' asCharacterSet).
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'characterSets' -> () From: ( | {
         'ModuleInfo: Module: korzLexer InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> () From: ( | {
         ...
         lexer = bootstrap define: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> () ToBe: bootstrap addSlotsTo: (
             bootstrap remove: 'parent' From:
             bootstrap remove: 'spaces' From:
             bootstrap remove: 'tokenTraits' From:
             bootstrap remove: 'tokens' From:
             globals parseKit lexer copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> () From: ( |
             {} = 'Comment: To make your lexer,
create a copy-down child of
this object and replace the contents of the spaces 
and tokens slots. -- dmu 8/99\x7fModuleInfo: Creator: globals korzParser lexer.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> () From: ( | {
         'ModuleInfo: Module: korzLexer InitialContents: InitializeToExpression: (0)\x7fVisibility: private'
        
         nestingDepth <- 0.
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> () From: ( | {
         'ModuleInfo: Module: korzLexer InitialContents: FollowSlot\x7fVisibility: private'
        
         parent* = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> 'parent' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korzParser lexer parent.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> 'parent' -> () From: ( | {
         'Category: nesting\x7fModuleInfo: Module: korzLexer InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> 'parent' -> () From: ( | {
         'Category: nesting\x7fModuleInfo: Module: korzLexer InitialContents: FollowSlot\x7fVisibility: public'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> 'parent' -> () From: ( | {
         'Category: testing\x7fModuleInfo: Module: korzLexer InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> () From: ( | {
         'Category: change these to lex your language\x7fModuleInfo: Module: korzLexer InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> () From: ( | {
         ...
         tokenTraits = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> 'tokenTraits' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korzParser lexer tokenTraits.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> 'tokenTraits' -> () From: ( | {
         'ModuleInfo: Module: korzLexer InitialContents: FollowSlot'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> () From: ( | {
         ...
         tokens = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'korzParser' -> 'lexer' -> 'tokens' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals korzParser lexer tokens.
'.
            | ) .
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> () From: ( | {
         ...
         korzLexer = bootstrap define: bootstrap stub -> 'globals' -> 'modules' -> 'korzLexer' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals modules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'modules' -> 'korzLexer' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals modules korzLexer.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'korzLexer' -> () From: ( | {
         'ModuleInfo: Module: korzLexer InitialContents: FollowSlot\x7fVisibility: public'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'korzLexer' -> () From: ( | {
         'ModuleInfo: Module: korzLexer InitialContents: InitializeToExpression: (_CurrentTimeString)\x7fVisibility: public'
 ...
 bootstrap read: 'korzLexerTokens' From: 'applications/allKorz/korzParser'



 '-- Side effects'

 globals modules korzLexer postFileIn
