...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'ui1' -> () From: ( | {
         ...
         slotNameCpt = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'ui1' -> 'slotNameCpt' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals ui1 slotNameCpt.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'ui1' -> 'slotNameCpt' -> () From: ( | {
         'ModuleInfo: Module: slotNameCpt InitialContents: FollowSlot\x7fVisibility: public'
        
         button <- bootstrap stub -> 'globals' -> 'ui1' -> 'slotButton' -> ().
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'ui1' -> () From: ( | {
         ...
         slotNameCpt = bootstrap setObjectAnnotationOf: bootstrap stub -> 'traits' -> 'ui1' -> 'slotNameCpt' -> () From: ( |
             {} = 'ModuleInfo: Creator: traits ui1 slotNameCpt.
'.
            | ) .
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'ui1' -> 'slotNameCpt' -> () From: ( | {
         ...
         parent* = bootstrap stub -> 'traits' -> 'ui1' -> 'slotNameCpt' -> ().
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'ui1' -> 'slotNameCpt' -> () From: ( | {
         ...
         create: n On: slt = ( |
            ...
            slot: slt.
            name: n.
            button: ui1 slotButton copy createOn: self.
            self).
        } | ) 
