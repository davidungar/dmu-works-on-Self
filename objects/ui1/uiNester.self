...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'ui1' -> () From: ( | {
         ...
         uiNester = bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'ui1' -> 'uiNester' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals ui1 uiNester.
\x7fIsComplete: '.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'ui1' -> 'uiNester' -> () From: ( | {
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'ui1' -> () From: ( | {
         ...
         uiNester = bootstrap setObjectAnnotationOf: bootstrap stub -> 'traits' -> 'ui1' -> 'uiNester' -> () From: ( |
             {} = 'Comment: traits nester is an abstract traits object.  There are three kinds of
     nesters--the world, bodies in that world, and components of bodies.\x7fModuleInfo: Creator: traits ui1 uiNester.
'.
            | ) .
        } | ) 
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'ui1' -> 'uiNester' -> () From: ( | {
         ...
         descendentResponsibilities = bootstrap setObjectAnnotationOf: bootstrap stub -> 'traits' -> 'ui1' -> 'uiNester' -> 'descendentResponsibilities' -> () From: ( |
             {} = 'ModuleInfo: Creator: traits ui1 uiNester descendentResponsibilities.
'.
            | ) .
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'ui1' -> 'uiNester' -> 'descendentResponsibilities' -> () From: ( | {
         'ModuleInfo: Module: uiNester InitialContents: FollowSlot\x7fVisibility: public'
