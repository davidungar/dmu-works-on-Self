...
restart XQuartz. -- claude & dmu 6/2026\x7fModuleInfo: Module: worldMorph InitialContents: FollowSlot\x7fVisibility: private'
         ...
         ensureXQuartzKeyEquivalentsOffOnce = ( |
             pref.
            | 
            desktop xKeyEquivCheckDone ifTrue: [^ self].
            (host osName == 'macOSX') ifFalse: [^ self].
            (snapshotAction commandLine includes: '-headless') ifTrue: [^ self].
            desktop xKeyEquivCheckDone: true.
...
the user at the readme. -- claude & dmu 5/2026\x7fModuleInfo: Module: worldMorph InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'worldMorph' -> () From: ( | {
         'Category: window management\x7fComment: Map a snapshot window\'s display name onto one this host can honor,
 ...
 must fall back to the default X display. -- claude & dmu 5/2026\x7fModuleInfo: Module: worldMorph InitialContents: FollowSlot'
...
IfAbsent: argument if none.\x7fModuleInfo: Module: worldMorph InitialContents: FollowSlot\x7fVisibility: public'
 ...
 running), fall back to Quartz. -- claude & dmu 5/2026\x7fModuleInfo: Module: worldMorph InitialContents: FollowSlot\x7fVisibility: private'
         ...
         windowCanvasPrototypeForDisplay: dispName = ( |
            ...
            (host osName == 'macOSX') ifTrue: [ensureXQuartzKeyEquivalentsOffOnce].
