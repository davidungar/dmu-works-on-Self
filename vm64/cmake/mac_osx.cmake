...
elseif(CMAKE_OSX_VARS_NEED_INITIALIZATION)
  ...
  if(${platform_processor} STREQUAL "aarch64")
    set(_osx_arch "arm64")
  elseif(${platform_processor} STREQUAL "amd64")
    set(_osx_arch "x86_64")
  else()
    set(_osx_arch ${platform_processor})
  endif()
  set(CMAKE_OSX_ARCHITECTURES ${_osx_arch} CACHE STRING
  ...
  if(NOT CMAKE_OSX_SYSROOT)
    # Legacy SDK detection for i386/ppc using xcodebuild
...
if(${platform_processor} STREQUAL "aarch64")
  ...
  if(SELF_QUARTZ)
    ...
    add_framework_to_list(frameworks QuartzCore)
    add_framework_to_list(frameworks IOSurface)
  endif()
else()
...
#
# Mac compile definitions, independent of  generator
#
